                ...
                data-bs-target="#tambahModal">Tambah</a>
                    ...
                    <div class="card-body p-0">
                                    ...
                                    <thead class="table-default parent" data-child="{{ $index->id }}">
                                        <tr>
                                            <th class="text-left col-1"
                                                onclick="showHideRow('hidden_row{{ $index->id }}');"><a href="#"
                                                    class="btn btn-dark btn-sm btnWord">Expand</a>
                                            <th class="text-left col-1"><a
                                                    href="{{ route('laporankompetensiopd', $index->id) }}" target="_blank"
                                                    class="btn btn-default btn-sm "><i class="fa-solid fa-file-word"></i>
                                                    Download</a></a> </th>
                                            {{-- <th class="text-left col-1"><a
                      ...
                      class="btn btn-primary btn-sm btnTambah">Tambah</a></th> --}}
                                    ...
                                    <tbody id="hidden_row{{ $index->id }}" class="hidden_row table table-hover"
                                        style="display: none;">
                                        @php
                                            $id_opd = $index->id;
                                        ...
                                        @if ($hubunganjabatan->first() == null)
                                            <tr>
                                                <th colspan="4" class="text-center alert alert-danger"><strong>TIDAK ADA
                                                        DATA</strong></th>
                                            </tr>
                                        @endif
                                        @foreach ($hubunganjabatan as $index)
                                            <tr>
                                                <th class="text-left col-1">
                                                    <a href="/laporan-kompetensi/{{ $index->kode_jabatan }}"
                                                        class="btn btn-default btn-sm" data-id_opd="{{ $id_opd }}"
                                                        data-kode_jabatan="{{ $index->kode_jabatan }}"
                                                ...
                                                <th class="text-primary">
                                                    ...
                                                    </span><b>{{ $index->datajabatan->nama_jabatan }}</b>
                                                </th>
                                                    ...
                                                    @foreach ($lvl2 as $index)
                                                        <tr>
                                                            ...
                                                            <th class="text-default">
                                                                &emsp;<span class="fa fa-chevron-circle-right"></span>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="" name="deleteForm" id="deleteForm" method="POST">
                                            ...
                                            <div class="modal-body">
                                                <p>Yakin ingin menghapus <strong id="valuedinas"></strong> ?<br>Semua data
                                                    seperti
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $.each(response.jabatan, function(index, val) {
                                    $('#jabatan').append('<option value="' + val.id +
                                        '" @if (old('jabatan') == "' +val.id+ '") selected @endif >' +
                                        val.nama_jabatan + '</option>')
                                });
                    ...
                    if ($(this).val() != '') {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $.each(response.jabatan, function(index, val) {
                                    $('#jabatanchild').append('<option value="' + val.id +
                                        '" @if (old('jabatan') == "' +val.id+ '") selected @endif >' +
                                        val.nama_jabatan + '</option>')
                                });
