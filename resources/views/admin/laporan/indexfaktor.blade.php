            ...
            <table class="table align-items-center table-flush table-hover table-bordered" id="customerList"
              ...
              <thead class="table-default parent" data-child="{{ $index->id }}">
                <tr>
                  ...
                  <th class="text-left col-1" ><a href="{{route('laporanfaktoropd',$index->id)}}" target="_blank"
                    class="btn btn-default btn-sm "><i class="fa-solid fa-file-word"></i> Download</a></a> </th>
