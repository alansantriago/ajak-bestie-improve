      ...
      <div class="card bg-secondary shadow mb-3">
        ...
        <div class="card-body">
          ...
          <div class="pl-lg-2">
            ...
            <div class="form-group{{ $errors->has('ut<?= ($i+1)?>') ? ' has-danger' : '' }}">
              <div class="row align-items-center">
                <div class="col-8">
                  <label class="form-control-label" for="ut<?= ($i+1)?>">{{ __('Uraian Tugas
                    ke-'.($i+1))}}
                  </label>
                  <textarea name="uraian_tugas[]" id="ut<?=($i+1)?>" cols="30" rows="3"
                    class="form-control form-control-{{ $errors->has('ut'.($i+1)) ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Uraian Tugas'.($i+1)) }}"
                    value="{{ old('uraian_tugas.'.($i),$index->uraian_tugas) }}"
                    required>{{ old('uraian_tugas.'.($i),$index->uraian_tugas) }}</textarea>
                  @if ($errors->has('ut'.($i+1)))
                  <span class="invalid-feedback" role="alert">
                ...
                <div class="col-4">
                  <label class="form-control-label" for="hk{{($i+1) }}">{{ __('Hasil Kerja ke-'.($i+1))}}</label>
                  <input type="text" name="hasil_kerja[]" id="hk{{($i+1) }}"
                    class="form-control form-control-{{ $errors->has('hk'.($i+1)) ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Hasil Kerja '.($i+1)) }}"
                    value="{{ old('hasil_kerja.'.($i+1),$index->hasil_kerja) }}" required autofocus>

                  @if ($errors->has('hk'.($i+1)))
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('hk'.($i+1)) }}
                    </strong>
                  </span>
                  @endif
                </div>
      ...
      <div class="card bg-secondary shadow mb-3">
        ...
        <div class="card-body">
          ...
          <div class="pl-lg-2">
            ...
            <div class="form-group{{ $errors->has('bahan'.($i+1)) ? ' has-danger' : '' }}">
              <div class="row align-items-center">
                <div class="col-8">
                  <label class="form-control-label" for="bahan".($i+1)>{{ __('Bahan Kerja
                    ke-'.($i+1))}}
                  </label>
                  <textarea name="bahan_kerja[]" id="bahan".($i+1) cols="30" rows="3"
                    class="form-control form-control-{{ $errors->has('bahan'.($i+1)) ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Bahan Kerja'.($i+1)) }}"
                    value="{{ old('bahan_kerja.'.($i),$index->bahan_kerja) }}"
                    required>{{ old('bahan_kerja.'.($i),$index->bahan_kerja) }}</textarea>
                  @if ($errors->has('bahan'.($i+1)))
                  <span class="invalid-feedback" role="alert">
                ...
                <div class="col-4">
                  <label class="form-control-label" for="penggunaan_bahan{{($i+1) }}">{{ __('Penggunaan Dalam Tugas
                    ke-'.($i+1))}}</label>
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan{{($i+1) }}"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan'.($i+1)) ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas '.($i+1)) }}"
                    value="{{ old('penggunaan_bahan.'.($i+1),$index->penggunaan_bahan) }}" required autofocus>

                  @if ($errors->has('penggunaan_bahan'.($i+1)))
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('penggunaan_bahan'.($i+1)) }}
                    </strong>
                  </span>
                  @endif
                </div>
            ...
            <?php $i++ ?>
            @endforeach
            @while($i < 10) <div class="form-group{{ $errors->has('bahan'.($i+1)) ? ' has-danger' : '' }}">
              <div class="row align-items-center">
                <div class="col-8">
                  <label class="form-control-label" for="bahan".($i+1)>{{ __('Bahan Kerja
                    ke-'.($i+1))}}
                  ...
                  <textarea name="bahan_kerja[]" id="bahan".($i+1) cols="30" rows="3"
                    class="form-control form-control-{{ $errors->has('bahan'.($i+1)) ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Bahan Kerja'.($i+1)) }}" value="{{ old('bahan_kerja.'.($i)) }}"
                    required>{{ old('bahan_kerja.'.($i)) }}</textarea>
                  @if ($errors->has('bahan'.($i+1)))
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('bahan
                      '.($i+1)) }}
                ...
                <div class="col-4">
                  ...
                  <input type="text" name="penggunaan_bahan[]" id="penggunaan_bahan{{($i+1) }}"
                    class="form-control form-control-{{ $errors->has('penggunaan_bahan'.($i+1)) ? ' is-invalid' : '' }}"
                    placeholder="{{ __('Penggunaan Dalam Tugas '.($i+1)) }}"
                    value="{{ old('penggunaan_bahan.'.($i+1)) }}" required autofocus>
    ...
    <div class="card bg-secondary shadow mb-3">
      ...
      <div class="card-body">
        ...
        <div class="pl-lg-2">
          ...
          <div class="form-group{{ $errors->has('perangkat_kerja'.($i+1)) ? ' has-danger' : '' }}">
            <div class="row align-items-center">
              <div class="col-8">
                <label class="form-control-label" for="perangkat_kerja".($i+1)>{{ __('Perangkat Kerja
                  ke-'.($i+1))}}
                </label>
                <textarea name="perangkat_kerja[]" id="perangkat_kerja".($i+1) cols="30" rows="3"
                  class="form-control form-control-{{ $errors->has('perangkat_kerja'.($i+1)) ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Perangkat Kerja'.($i+1)) }}"
                  value="{{ old('perangkat_kerja.'.($i),$index->perangkat_kerja) }}"
                  required>{{ old('perangkat_kerja.'.($i),$index->perangkat_kerja) }}</textarea>
                @if ($errors->has('perangkat_kerja'.($i+1)))
                <span class="invalid-feedback" role="alert">
              ...
              <div class="col-4">
                <label class="form-control-label" for="penggunaan{{($i+1) }}">{{ __('Penggunaan Dalam Tugas
                  ke-'.($i+1))}}</label>
                <input type="text" name="penggunaan[]" id="penggunaan{{($i+1) }}"
                  class="form-control form-control-{{ $errors->has('penggunaan'.($i+1)) ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas '.($i+1)) }}"
                  value="{{ old('hasil_kerja.'.($i+1),$index->penggunaan) }}" required autofocus>

                @if ($errors->has('penggunaan'.($i+1)))
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $errors->first('penggunaan'.($i+1)) }}
                  </strong>
                </span>
                @endif
              </div>
          ...
          @endforeach
          @while($i < 10) <div
            class="form-group{{ $errors->has('perangkat_kerja'.($i+1)) ? ' has-danger' : '' }}">
            <div class="row align-items-center">
              <div class="col-8">
                <label class="form-control-label" for="perangkat_kerja".($i+1)>{{ __('Perangkat Kerja
                  ke-'.($i+1))}}
                ...
                <textarea name="perangkat_kerja[]" id="perangkat_kerja".($i+1) cols="30" rows="3"
                  class="form-control form-control-{{ $errors->has('perangkat_kerja'.($i+1)) ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Perangkat Kerja'.($i+1)) }}" value="{{ old('perangkat_kerja.'.($i)) }}"
                  required>{{ old('perangkat_kerja.'.($i)) }}</textarea>
                @if ($errors->has('perangkat_kerja'.($i+1)))
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $errors->first('perangkat_kerja
                    '.($i+1)) }}
              ...
              <div class="col-4">
                ...
                <input type="text" name="penggunaan[]" id="penggunaan{{($i+1) }}"
                  class="form-control form-control-{{ $errors->has('penggunaan'.($i+1)) ? ' is-invalid' : '' }}"
                  placeholder="{{ __('Penggunaan Dalam Tugas '.($i+1)) }}"
                  value="{{ old('hasil_kerja.'.($i+1)) }}" required autofocus>
