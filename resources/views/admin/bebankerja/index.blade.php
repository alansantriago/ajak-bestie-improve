                                ...
                                @foreach ($opd as $index)
                                    <thead class="table-default parent" data-child="{{ $index->id }}">
                                        <tr>
                                            ...
                                            <th class=" text-dark py-3"
                                                onclick="showHideRow('hidden_row{{ $index->id }}');">
                                                {{ $index->nama_dinas }}
                                            </th>
                                            <th class="text-right pr-6"colspan="2"
                                                onclick="showHideRow('hidden_row{{ $index->id }}');"></th>
                                        </tr>
                                    </thead>
                                    <tbody id="hidden_row{{ $index->id }}" class="hidden_row table table-hover"
                                        ...
                                        @if ($hubunganjabatan->first() == null)
                                            <tr>
                                                <th colspan="5" class="text-center alert alert-danger"><strong>TIDAK ADA
                                                        DATA</strong></th>
                                            </tr>
                                        @endif
