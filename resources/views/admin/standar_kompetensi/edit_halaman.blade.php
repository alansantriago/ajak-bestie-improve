                ...
                <div class="card bg-secondary shadow mb-3">
                    ...
                    <div class="card-body">
                        <div class="pl-lg-4">
                            ...
                            <form role="form" action="/standar-kompetensi/{{ $jabatan->id }}" method="POST"
                                id="editForm">
                                @csrf
                                @method('PUT')
                                <input name="id" class="form-control" placeholder="Kode Organisasi Perangkat Daerah"
                                    type="number" maxlength="20" value="{{ $jabatan->id }}" required hidden>
                                <div
                                    class="form-group kelompok_jabatan{{ $errors->has('kelompok_jabatan') ? ' has-danger' : '' }}">

                                    <label class="form-control-label"
                                        for="kelompok_jabatan">{{ __('Kelompok Jabatan') }}</label>
                                    <select data-live-search="true"
                                        class="form-select selectpicker form-control- form-control{{ $errors->has('kelompok_jabatan') ? ' is-invalid' : '' }}"
                                        name="kelompok_jabatan" id="kelompok_jabatan" aria-label="Default select example"
                                        required>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') == '') selected @endif value='' disabled>
                                            Pilih Kelompok Jabatan
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Administrator') selected @endif
                                            value='Jabatan Administrator'>Jabatan Administrator
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Pengawas') selected @endif value='Jabatan Pengawas'>
                                            Jabatan Pengawas
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Pelaksana') selected @endif value='Jabatan Pelaksana'>
                                            Jabatan Pelaksana
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Kelerek - Pelaksana') selected @endif
                                            value='Jabatan Kelerek - Pelaksana'>
                                            Jabatan Kelerek - Pelaksana
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Operator - Pelaksana') selected @endif
                                            value='Jabatan Operator - Pelaksana'>
                                            Jabatan Operator - Pelaksana
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Teknisi - Pelaksana') selected @endif
                                            value='Jabatan Teknisi - Pelaksana'>
                                            Jabatan Teknisi - Pelaksana
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Fungsional') selected @endif
                                            value='Jabatan Fungsional'>Jabatan Fungsional
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Fungsional Ahli Pertama') selected @endif
                                            value='Jabatan Fungsional Ahli Pertama'>Jabatan Fungsional Ahli Pertama
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Fungsional Ahli Muda') selected @endif
                                            value='Jabatan Fungsional Ahli Muda'>Jabatan Fungsional Ahli Muda
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Fungsional Ahli Madya') selected @endif
                                            value='Jabatan Fungsional Ahli Madya'>Jabatan Fungsional Ahli Madya
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Fungsional Ahli Utama') selected @endif
                                            value='Jabatan Fungsional Ahli Utama'>Jabatan Fungsional Ahli Utama
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Fungsional Pemula') selected @endif
                                            value='Jabatan Fungsional Pemula'>Jabatan Fungsional Pemula
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Fungsional Terampil') selected @endif
                                            value='Jabatan Fungsional Terampil'>Jabatan Fungsional Terampil
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Fungsional Mahir') selected @endif
                                            value='Jabatan Fungsional Mahir'>Jabatan Fungsional Mahir
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Fungsional Penyelia') selected @endif
                                            value='Jabatan Fungsional Penyelia'>Jabatan Fungsional Penyelia
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Pimpinan Tinggi Pratama') selected @endif
                                            value='Jabatan Pimpinan Tinggi Pratama '>Jabatan Pimpinan Tinggi Pratama
                                        </option>
                                        <option @if (old('kelompok_jabatan', $standar_kompetensi != null ? $standar_kompetensi->kelompok_jabatan : '') ==
                                                'Jabatan Pimpinan Tinggi Madya') selected @endif
                                ...
                                <div class="form-group{{ $errors->has('urusan_pemerintahan') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                        for="urusan_pemerintahan">{{ __('Urusan Pemerintahan') }}</label>
                                ...
                                <div class="form-group {{ $errors->has('integritas') ? ' has-danger' : '' }}">
                                    ...
                                    <select data-live-search="true"
                                        ...
                                        name="kompetensi[]" id="integritas" aria-label="Default select example"
                                        ...
                                        @foreach ($integritas as $index)
                                            <option @if (is_array(old('kompetensi', $kompetensi)) && in_array($index->id, old('kompetensi', $kompetensi))) selected @endif
                                                value='{{ $index->id }}'>
                                                Integritas
                                                - Level {{ $index->level }}
                                            </option>
                                ...
                                <div class="form-group {{ $errors->has('komunikasi') ? ' has-danger' : '' }}">
                                    ...
                                    <select data-live-search="true"
                                        ...
                                        @foreach ($komunikasi as $index)
                                            <option @if (is_array(old('komunikasi', $kompetensi)) && in_array($index->id, old('komunikasi', $kompetensi))) selected @endif
                                                value='{{ $index->id }}'>
                                                Komunikasi
                                                - Level {{ $index->level }}
                                            </option>
                                ...
                                <div class="form-group {{ $errors->has('pelayanan_publik') ? ' has-danger' : '' }}">
                                    ...
                                    <label class="form-control-label"
                                        for="pelayanan_publik">{{ __('Pelayanan Publik') }}</label>
                                    <select data-live-search="true"
                                        class="form-select selectpicker form-control- form-control{{ $errors->has('pelayanan_publik') ? ' is-invalid' : '' }}"
                                        name="kompetensi[]" id="pelayanan_publik" aria-label="Default select example"
                                        required>
                                ...
                                <div class="form-group {{ $errors->has('pengembangan_diri') ? ' has-danger' : '' }}">
                                    ...
                                    <label class="form-control-label"
                                        for="pengembangan_diri">{{ __('Pengembangan Diri dan orang lain') }}</label>
                                    <select data-live-search="true"
                                        class="form-select selectpicker form-control- form-control{{ $errors->has('pengembangan_diri') ? ' is-invalid' : '' }}"
                                        name="kompetensi[]" id="pengembangan_diri" aria-label="Default select example"
                                        required>
                                ...
                                <div class="form-group {{ $errors->has('mengelola_perubahan') ? ' has-danger' : '' }}">
                                    ...
                                    <label class="form-control-label"
                                        for="mengelola_perubahan">{{ __('Mengelola Perubahan') }}</label>
                                    <select data-live-search="true"
                                        class="form-select selectpicker form-control- form-control{{ $errors->has('mengelola_perubahan') ? ' is-invalid' : '' }}"
                                        name="kompetensi[]" id="mengelola_perubahan" aria-label="Default select example"
                                        required>
                                ...
                                <div class="form-group {{ $errors->has('perekat_bangsa') ? ' has-danger' : '' }}">
                                    ...
                                    <label class="form-control-label"
                                        for="perekat_bangsa">{{ __('Perekat Bangsa') }}</label>
                                    <select data-live-search="true"
                                        class="form-select selectpicker form-control- form-control{{ $errors->has('perekat_bangsa') ? ' is-invalid' : '' }}"
                                        name="kompetensi[]" id="perekat_bangsa" aria-label="Default select example"
                                        required>
                                ...
                                <div class="form-group {{ $errors->has('pangkat') ? ' has-danger' : '' }}">
                                    ...
                                    <select
                                        ...
                                        <option @if (old('pangkat', $standar_kompetensi != null ? $standar_kompetensi->pangkat : '') == 'Juru / (I.c)') selected @endif value='Juru / (I.c)'>
                                            Juru / <Strong>(I.c)</Strong>
                                        </option>
                                        <option @if (old('pangkat', $standar_kompetensi != null ? $standar_kompetensi->pangkat : '') == 'Juru Tk. I / (I.d)') selected @endif
                                            value='Juru Tk. I/ (I.d)'>
                                            Juru Tk. I / <Strong>(I.d)</Strong>
                                        </option>
                                        ...
                                        <option @if (old('pangkat', $standar_kompetensi != null ? $standar_kompetensi->pangkat : '') == 'Pengatur Muda Tk I / (II.b)') selected @endif
                                            value='Pengatur Muda Tk I / (II.b)'>Pengatur Muda Tk I /
                                            <Strong>(II.b)</Strong>
                                        </option>
                                        ...
                                        <option @if (old('pangkat', $standar_kompetensi != null ? $standar_kompetensi->pangkat : '') == 'Pengatur Tk I / (II.d)') selected @endif
                                            value='Pengatur Tk I / (II.d)'>Pengatur Tk I / <Strong>(II.d)</Strong>
                                        </option>
                                        <option @if (old('pangkat', $standar_kompetensi != null ? $standar_kompetensi->pangkat : '') == 'Penata Muda / (III.a)') selected @endif
                                            value='Penata Muda / (III.a)'>Penata Muda / <Strong>(III.a)</Strong>
                                        </option>
                                        <option @if (old('pangkat', $standar_kompetensi != null ? $standar_kompetensi->pangkat : '') == 'Penata Muda Tk. I / (III.b)') selected @endif
                                            value='Penata Muda Tk. I / (III.b)'>Penata Muda Tk. I /
                                            <Strong>(III.b)</Strong>
                                        </option>
                                        ...
                                        <option @if (old('pangkat', $standar_kompetensi != null ? $standar_kompetensi->pangkat : '') == 'Pembina / (IV.a)') selected @endif
                                            value='Pembina / (IV.a)'>Pembina / <Strong>(IV.a)</Strong>
                                        </option>
                                        <option @if (old('pangkat', $standar_kompetensi != null ? $standar_kompetensi->pangkat : '') == 'Pembina Tk. I / (IV.b)') selected @endif
                                            value='Pembina Tk. I / (IV.b)'>Pembina Tk. I / <Strong>(IV.b)</Strong>
                                        </option>
                                        <option @if (old('pangkat', $standar_kompetensi != null ? $standar_kompetensi->pangkat : '') == 'Pembina Utama Muda / (IV.c)') selected @endif
                                            value='Pembina Utama Muda / (IV.c)'>Pembina Utama Muda /
                                            <Strong>(IV.c)</Strong>
                                        </option>
                                        <option @if (old('pangkat', $standar_kompetensi != null ? $standar_kompetensi->pangkat : '') == 'Pembina Utama Madya / (IV.d)') selected @endif
                                            value='Pembina Utama Madya / (IV.d)'>Pembina Utama Madya /
                                            <Strong>(IV.d)</Strong>
                                        </option>
                                    </select>
                                ...
                                <div class="form-group{{ $errors->has('indikator_kinerja') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                        for="indikator_kinerja">{{ __('Indikator Kinerja') }}</label>
